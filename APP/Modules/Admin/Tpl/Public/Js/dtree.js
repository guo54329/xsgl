...
function dTree(objName) {
	...
	this.icon = {
		root		: '/xsgl/APP/Modules/Admin/Tpl/Public/Images/img/base.gif',
		folder		: '/xsgl/APP/Modules/Admin/Tpl/Public/Images/img/folder.gif',
		folderOpen	: '/xsgl/APP/Modules/Admin/Tpl/Public/Images/img/folderopen.gif',
		node		: '/xsgl/APP/Modules/Admin/Tpl/Public/Images/img/page.gif',
		empty		: '/xsgl/APP/Modules/Admin/Tpl/Public/Images/img/empty.gif',
		line		: '/xsgl/APP/Modules/Admin/Tpl/Public/Images/img/line.gif',
		join		: '/xsgl/APP/Modules/Admin/Tpl/Public/Images/img/join.gif',
		joinBottom	: '/xsgl/APP/Modules/Admin/Tpl/Public/Images/img/joinbottom.gif',
		plus		: '/xsgl/APP/Modules/Admin/Tpl/Public/Images/img/plus.gif',
		plusBottom	: '/xsgl/APP/Modules/Admin/Tpl/Public/Images/img/plusbottom.gif',
		minus		: '/xsgl/APP/Modules/Admin/Tpl/Public/Images/img/minus.gif',
		minusBottom	: '/xsgl/APP/Modules/Admin/Tpl/Public/Images/img/minusbottom.gif',
		nlPlus		: '/xsgl/APP/Modules/Admin/Tpl/Public/Images/img/nolines_plus.gif',
		nlMinus		: '/xsgl/APP/Modules/Admin/Tpl/Public/Images/img/nolines_minus.gif'
	};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
...
dTree.prototype.node = function(node, nodeId) {
	...
	if(node.pid == this.root.id){
		...
		/**组装checkbox开始*/
		checkboxSyntax = "<label><input type='checkbox' class='checked-focus' desc='" + node.cshow + "' name='" + node.cname + "' id='" + node.cname + "_" + node.id + "' value='" + node.cvalue + "' onClick='javascript: " + this.obj + ".checkNode(" + node.id+","+node.pid+","+node._hc + ",this.checked);'";
		//是否被选中
		if(node.cchecked)
