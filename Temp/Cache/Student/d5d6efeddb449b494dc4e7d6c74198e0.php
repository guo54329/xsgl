...
<div class="panel panel-default">
	  ...
	  <div class="panel-body">
		 <table class='table table-bordered table-hover'>
			<tr><th>学期</th><th>课程</th><th>序号</th><th>任务标题</th><th>发布教师</th><th>发布时间</th><th>完成状态</th><th>是否重做</th><th>自评成绩</th><th>实训成绩</th><th>操作</th></tr>
			<?php $i=1;?>
			<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
				...
				<td><?php echo ($v["isrec"]); ?></td>

				<td><?php if($v['status'] == 0 ): ?>无<?php else: ?><a href="<?php echo U(GROUP_NAME.'/Excise/sxexciseDiscuss',array('peid'=>$v['peid']));?>" class="btn btn-default" ><span class="glyphicon glyphicon-eye-open"></span> 讨论</a><?php endif; ?></td>
