...
<head>
<meta charset="utf-8">
<meta http-equiv="refresh" content="60"><!--每隔10s刷新一次-->
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="row">
          <div class="col-md-12">
            <div class="alert alert-success" style="font-size:18px;margin-bottom:2px;">
                  <i class="glyphicon glyphicon-ok"></i>
                  <strong>提示：</strong><?php echo ($xsxm); ?>，<?php echo ($wel); ?>
              </div>
          </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
               ...
               <table class="table table-bordered">
                    <tr>
                      <td>
                        <div class="form-inline" style="height:80px;line-height: 22px;">
                ...
                <!-- js的使用 start-->
                 ...
                 <button type="submit" class="btn btn-info btnsearch"><span class='glyphicon glyphicon-search'></span> 查询任务</button>
                </form>
                <a href="<?php echo U(GROUP_NAME.'/Index/sysNews');?>" class="btn btn-info" style="width: 270px;line-height: 16px;font-size: 16px;
                          display: block;margin-bottom: 6px;"><span class="glyphicon glyphicon-bullhorn"></span>  查看管理员和教师发布的消息</a>
              </div>
                      </td>
                    </tr> 
                </table>
            ...
            <div class="col-md-6">
               ...
               <table class="table table-bordered">
                     <tr><td align="left"><span style="line-height: 40px;"><?php echo ($sinfor["stulogin"]); ?></span></td></tr>
                </table>
            </div> 
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
               <h4><span class="glyphicon glyphicon-time"></span> 待完成任务 <span class="badge"><?php echo ($num); ?></span></h4>
               <table class="table table-bordered table-hover">
                    <tr>
                        <td class="tdtitle">学期</td><td class="tdtitle">课程</td><td class="tdtitle">序号</td><td class="tdtitle">任务标题</td><td class="tdtitle">发布教师</td><td class="tdtitle">发布时间</td><td class="tdtitle">完成状态</td></td>
                    </tr>
                    <?php $i=1;?>
          <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
            ...
            <td>
              <?php if($v['status'] == 0 ): ?><a href="<?php echo U(GROUP_NAME.'/Excise/sxsubexciseDesc',array('seid'=>$v['seid']));?>" class="btn" style="font-size: 16px;"><span class="glyphicon glyphicon-hand-right"></span> 去完成</a><?php else: ?><img src="__PUBLIC__/Images/finish.png" style="height: 40px;" /><?php endif; ?>
