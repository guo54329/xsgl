    ...
    <div class="form-group">
        <form class="form-signin" role="form" method="post" action="<?php echo U(GROUP_NAME.'/Index/fpass');?>">
            <div class="input-group">
                ...
                <input type="text" name="name" class="form-control" placeholder="登录用户名" required autofocus />
            </div>
            <div class="input-group">
                <div class="input-group-addon"><span class="glyphicon glyphicon-user"></span>
                 </div>
                <input type="text" name="zsxm" class="form-control" placeholder="真实姓名" required />
            </div>
            <button class="btn btn-lg btn-warning btn-block" type="submit">提交</button>
        </form>
        <div class="sys c">欢迎使用<?php echo ($g_site["title"]); ?></div>
    </div>
</div>
<div class="footer">    
    <div class="copyright">         
