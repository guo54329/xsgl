...
<div class="panel panel-default">
	<div class="panel-heading headalign">
	   <a href="<?php echo U(GROUP_NAME.'/Basicdata/office');?>" class="btn btncoursetable"><span class="glyphicon glyphicon-home"></span> 处室维护</a><span class="btn xiexian">/</span><a  class="btn btn4">添加处室</a>
	</div>
