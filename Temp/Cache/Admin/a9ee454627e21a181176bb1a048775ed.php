...
<div class="panel panel-default">
	  ...
	  <div class="panel-footer footeralign">
		<div class="form-inline">
			...
			<a href="<?php echo U(GROUP_NAME.'/Excise/coursetableSave');?>" class="btn btn-info btnw"><span class="glyphicon glyphicon-plus"></span> 添加课程</a>&nbsp;&nbsp;<span>提示：请选择其中一种方式，然后单击查询！</span><br/>
	  		方式一：
			...
			<?php if(is_array($coursetable)): foreach($coursetable as $key=>$v): ?><tr>
				...
				<td align="left">　
				   <a href="<?php echo U(GROUP_NAME.'/Excise/sxpubexciseList',array('scid'=>$v['scid']));?>" class="btn btn-default btnw" title="查看指定教师发布的指定课程的任务列表！"><span class="glyphicon glyphicon-eye-open"></span> 任务列表</a>&nbsp;
					...
					<?php if( $pubnum != 0): ?><a href="<?php echo U(GROUP_NAME.'/Excise/sxcoursePackage',array('scid'=>$v['scid']));?>" class="btn btn-default btnw" title="将该课程所有任务和学生作业打包下载！"><span class="glyphicon glyphicon-save"></span> 打包下载</a>&nbsp;<?php endif; ?>
