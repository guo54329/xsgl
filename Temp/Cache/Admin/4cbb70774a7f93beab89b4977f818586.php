...
<div class="panel panel-default">
	  <div class="panel-heading">学期维护 </div>
	  <div class="panel-footer footeralign"><a href="<?php echo U(GROUP_NAME.'/Basicdata/saveTerm');?>" class="btn btn-info"><span class="glyphicon glyphicon-plus"></span> 添加</a>
	  </div>
