...
<div class="panel panel-default">
	  ...
	  <div class="panel-body">
		 <table class="table table-bordered table-hover">
			...
			<tr style="text-align: center; font-weight: bold;"><td width="5%">ID</td><td width="16%">任务题目</td><!--<td>任务描述</td><td>任务附件</td>--><td width="9%">发布状态</td><td width="16%">发布时间</td><td width="8%">完成情况</td><td align="left">操作(删除：1、无学生提交(若有一键重做)，2、单击“发布”撤销发布状态！)</td></tr>
			<?php $i=1;?>
