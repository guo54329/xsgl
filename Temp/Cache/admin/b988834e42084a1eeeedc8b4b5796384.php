...
<link rel="shortcut icon" href="__FAVICON__/Images/fav.png" type="image/x-icon" />
...
<div id="header">
	...
	<div class="navigation">
		<ul>
			<li>欢迎您，<a href="<?php echo U(GROUP_NAME.'/Userinfor/index');?>" target='nr'><?php echo ($username); ?></a>！&nbsp;&nbsp;您的身份：<?php if($uid == 1): ?>超级管理员<?php else: ?><a href="<?php echo U(GROUP_NAME.'/Userinfor/access');?>" target='nr'><?php echo ($role); ?></a><?php endif; ?></li>
...
<div id="content">
	<div class="left_menu">
          ...
          <h4 class="M8"><span></span>系统运行设置</h4>
          <div class="list-item none">
            <a href="<?php echo U(GROUP_NAME.'/Index/infor');?>" target='nr'>控制台</a>
        ...
        <li>
          ...
          <div class="list-item none">
          <a href="<?php echo U(GROUP_NAME.'/Home/addNews');?>" target='nr'>发布系统消息</a>
          <a href="<?php echo U(GROUP_NAME.'/Home/news');?>" target='nr'>管理现有消息</a>
          </div>
        </li>      
        ...
        <hr/><li>
          ...
          <div class="list-item none">
            <!-- <a href="<?php echo U(GROUP_NAME.'/Userinfor/index');?>" target='nr'>个人登录信息</a> -->
            <?php if($uid != 1): ?><a href="<?php echo U(GROUP_NAME.'/Userinfor/access');?>" target='nr'>查看个人权限</a><?php endif; ?>
		...
		<div class="m-right">
			<div class="main" >
				<iframe name="nr" src="<?php echo U(GROUP_NAME.'/Index/infor');?>" style="width:100%;height:100%;"  frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="yes" allowtransparency="yes"></iframe>
			</div>
		</div>
</div>
