	...
	<div class="panel-heading headalign">
	  ...
	  <div class="panel-body">
		 <table class='table table-bordered table-hover'>
			...
			<strong>附件下载：</strong><a href="<?php echo U(GROUP_NAME.'/Excise/sxpubexciseDownAttach',array('peid'=>$excisedesc['peid']));?>"  ><span class="glyphicon glyphicon-save"></span> <?php echo ($excisedesc["filename"]); ?>(<?php echo format_bytes(filesize($oldurl.($excisedesc['filename']))); ?>)</a>&nbsp;&nbsp;
