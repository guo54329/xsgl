...
<div class="panel panel-default">
	  <div class="panel-heading headalign">
		<a href="<?php echo U(GROUP_NAME.'/Rbac/node');?>" class="btn  btncoursetable"><span class="glyphicon glyphicon-home"></span> 节点列表</a><span class="btn xiexian">/</span><a  class="btn btn4">修改节点</a>
	  </div>
