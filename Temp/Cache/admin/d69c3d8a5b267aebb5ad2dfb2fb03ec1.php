				...
				var data = {'password':password,'password1':password1,'password2':password2};
			        ...
			        $.post(url,data,function(result){
			            ...
			            if(result.status == 0) {
			               ...
			               return dialog.success(result.message,"<?php echo U(GROUP_NAME.'/Userinfor/index');?>");
			            }
			        },'JSON');
			});
	});
...
<div class="panel panel-default">
	  <div class="panel-heading headalign">
			<a  class="btn  btncoursetable"><span class="glyphicon glyphicon-home"></span> 修改登录密码</a>
	 </div>
