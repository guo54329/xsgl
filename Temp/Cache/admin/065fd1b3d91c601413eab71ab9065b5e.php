...
<div class="panel panel-default">
	  <div class="panel-heading headalign">
		...
		<a href="<?php echo U(GROUP_NAME.'/Home/resetNEWS');?>" class="btn btn-info btn6"><span class="glyphicon glyphicon-retweet"></span> 清除演示数据</a> <span class="glyphicon glyphicon-info-sign"></span>  请在系统部署好使用之前使用该功能！
	  ...
	  <div class="panel-body">
		<table class="table table-bordered table-hover tablesorter">
		  <thead>
			<tr style="text-align: center;font-weight: bold;"><th style="text-align: center;" width="8%">序号</th><td>标题</td><td>内容</td><th style="text-align: center;">接收对象</th><th style="text-align: center;" width="10%">发布者</th><th style="text-align: center;">发布时间</th><td>操作</td></tr>
		   </thead>
		   <tbody>
		   	<?php $i=1;?>
			<?php if(is_array($info)): foreach($info as $key=>$v): ?><tr align='center'>
				...
				<td align='left' width="30%"><?php echo ($v["content"]); ?></td>
				<td align='left'>
