...
<div class="panel panel-default">
	<div class="panel-heading headalign">
	   <a href="<?php echo U(GROUP_NAME.'/Basicdata/professional');?>" class="btn btncoursetable"><span class="glyphicon glyphicon-home"></span> 专业维护</a><span class="btn xiexian">/</span><a  class="btn btn4"><?php echo ($professional["op"]); ?></a>
	</div>
