			...
			<tr>
				...
				<td>
				    <select name='zjsj' class="form-control" style="width: 500px;">
						...
						<?php if(is_array($term)): foreach($term as $key=>$v): ?><option value="<?php echo ($v["zjsj"]); ?>"  <?php if($classes['zjsj'] == $v['zjsj']): ?>selected="selected"<?php endif; ?>  ><?php echo ($v["zjsj"]); ?></option><?php endforeach; endif; ?>
					</select>
				</td>
			</tr>
			<tr>
