...
<div class="panel panel-default">
	  <div class="panel-heading headalign">
		<a  class="btn  btncoursetable"><span class="glyphicon glyphicon-home"></span> 节点列表</a>&nbsp;&nbsp;&nbsp;&nbsp;<span class="label label-default text-left">当前节点个数 <?php echo ($num); ?></span><!--
		<a href="<?php echo U(GROUP_NAME.'/Rbac/resetNODE');?>" class="btn btn-info btn6" ><span class="glyphicon glyphicon-retweet"></span> 清除演示数据</a> <span class="glyphicon glyphicon-info-sign"></span>  请在系统部署好使用之前使用该功能！-->
