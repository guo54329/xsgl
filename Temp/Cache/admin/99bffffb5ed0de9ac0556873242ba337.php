...
<div class="panel panel-default">
	<div class="panel-heading headalign">
	   <a href="<?php echo U(GROUP_NAME.'/Basicdata/course');?>" class="btn btncoursetable"><span class="glyphicon glyphicon-home"></span> 课程维护</a><span class="btn xiexian">/</span><a  class="btn btn4">添加课程</a>
	</div>
