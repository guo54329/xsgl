    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-success fade in" style="font-size:18px;margin-bottom:2px;">
                    ...
                    <strong>提示：</strong><?php echo ($username); ?>，<?php echo ($wel); ?>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-8">
               ...
               <table class="table table-bordered table-hover">
                   <tr><td class="tdtitle" style="width: 180px;">统计项</td>
            ...
            <div class="col-md-4">
             ...
             <div id="container" style="min-width: 200px;min-height: 314px;border-left:1px solid #ddd;border-right:1px solid #ddd;border-bottom:1px solid #ddd;padding:2px 1px;margin-top: -10px;background-color: none;"></div>
            </div> 
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <table class="table table-bordered table-hover">
                <tr><td class="tdtitle" style="width:140px;">运行环境</td><td align="left"><?php echo ($sinfor["pe"]); ?></td></tr>
