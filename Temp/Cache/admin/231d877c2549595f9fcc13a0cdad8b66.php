...
<div class="panel panel-default">
	  <div class="panel-heading headalign">
		...
		<a href="<?php echo U(GROUP_NAME.'/Basicdata/resetCOU');?>" class="btn btn-info btn6"><span class="glyphicon glyphicon-retweet"></span> 清除演示数据</a> <span class="glyphicon glyphicon-info-sign"></span>  请在系统部署好使用之前使用该功能！
