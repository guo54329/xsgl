...
<div class="panel panel-default">
	  ...
	  <div class="panel-body">
		 <table class='table table-bordered table-hover'>
		    ...
		    <tr class="desc">
		    <td colspan="10">
		    <strong>任务标题：</strong><?php echo ($excisedesc["title"]); ?>&nbsp;&nbsp;<strong>附件下载：</strong><a href="<?php echo U(GROUP_NAME.'/Excise/sxpubexciseDownAttach',array('peid'=>$excisedesc['peid']));?>"  ><span class="glyphicon glyphicon-save"></span> <?php echo ($excisedesc["filename"]); ?>(<?php echo format_bytes(filesize($oldurl.($excisedesc['filename']))); ?>)</a><strong>&nbsp;&nbsp;发布时间：</strong><?php echo (date('Y-m-d H:i:s',$excisedesc["pubtime"])); ?><br/>
