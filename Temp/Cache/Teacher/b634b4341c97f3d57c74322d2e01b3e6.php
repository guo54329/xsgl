...
<div class="panel panel-default">
	  <div class="panel-heading headalign">
		  ...
		  <span style="float:right;">
			<button class="btn btn-info" onclick="myrefresh()"><span class="glyphicon glyphicon-refresh"></span> 刷新</button>&nbsp;&nbsp;间隔10秒后自动刷新 &nbsp;&nbsp;&nbsp;&nbsp;
	  ...
	  <div class="form-control">
		    ...
		    完成情况：
		    <?php $subtotalnum=M('sxsubexcise')->where("peid=$peid")->count(); $suboknum=M('sxsubexcise')->where("peid=$peid and status=1")->count(); if($suboknum==0){ echo "<b><span class='numColor'>".$suboknum."</span>人完成,共".$subtotalnum."人<b/>"; }else{ echo "<b><span class='numColorok'>".$suboknum."</span>人完成,共".$subtotalnum."人</b>"; } ?><br/>
