...
<div class="panel panel-default">
	  ...
	  <div class="panel-footer footeralign"> 
	  		...
	  		<a href="<?php echo U(GROUP_NAME.'/Excise/sxsubexciseTable',array('peid'=>$excisedesc['peid']));?>" class="btn btn-info btnw"><span class="glyphicon glyphicon-floppy-save"></span> 导出</a>
	  </div>
