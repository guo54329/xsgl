...
<div class="panel panel-default">
	  ...
	  <div class="panel-footer footeralign"> 
	  		...
	  		<button class="btn btn-info" onclick="myrefresh()"><span class="glyphicon glyphicon-repeat"></span> 刷新</button>&nbsp;
	  		<a href="<?php echo U(GROUP_NAME.'/Excise/sxsubexciseTable',array('peid'=>$excisedesc['peid']));?>" class="btn btn-info browse"><span class="glyphicon glyphicon-floppy-save"></span> 完成情况</a>
	  </div>
	  <div class="panel-body">
		 <table class='table table-bordered table-hover'>
			...
			<tr><th>序号</th><th>学号</th><th>姓名</th><th>提交状态</th><th>提交时间</th><th>自评成绩</th><th>实训成绩</th><th>操作</th></tr>
			<?php $i=1;?>
	  ...
	  <div class="fresh"><button class="btn btn-info btnw" onclick="myrefresh()"><span class="glyphicon glyphicon-repeat"></span> 刷新</button></div>
</div>
</body>
</html>