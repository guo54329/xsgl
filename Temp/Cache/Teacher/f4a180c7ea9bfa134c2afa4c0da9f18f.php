    	...
    	<div class="row">
    		<div class="col-md-12">
		    	<div class="alert alert-success fade in" style="font-size:18px;margin-bottom: 2px;">
		            ...
		            <strong>提示：</strong><?php echo ($jsxm); ?>，<?php echo ($wel); ?>
		        </div>
	    	</div>
    	</div>
        <div class="row">
               ...
               <table class="table table-bordered">
                    <tr>
                    	<td style="line-height: 50px;">
	                    	<div class="form-inline" style="padding-top: 1px;">
	                    		<div class="row">
	                    			<div class="col-md-12">
	                    				<select id="scid" class="form-control" style="width: 100%;margin-bottom:10px;">
	                    		...
	                    		<div class="row">
	                    			<div class="col-md-4">
	                    				<a href="<?php echo U(GROUP_NAME.'/teacher/Excise/sxpubexciseSave');?>" class="btn btn-info btnsearch" id="addexcise"><span class="glyphicon glyphicon-plus"></span> 添加任务</a>
	                    			</div>
	                    			<div class="col-md-4">
										<a href="<?php echo U(GROUP_NAME.'/teacher/Excise/sxpubexciseList');?>" class="btn btn-info btnsearch" id="lookexcise"><span class="glyphicon glyphicon-eye-open"></span> 查看任务</a>
	                    			</div>
	                    			<div class="col-md-4">
										<a href="<?php echo U(GROUP_NAME.'/News/newsSave');?>" class="btn btn-info btnsearch"><span class="glyphicon glyphicon-plus"></span> 发布消息</a>
	                    			</div>
	                    		</div>
                    ...
                    <tr><td  style="line-height: 50px;">
                    	<div class="form-inline" style="margin:7px 0px;">
                    		<div class="row">
                    			<div class="col-md-4">
                    				<a href="<?php echo U(GROUP_NAME.'/News/sysNews');?>" class="btn btn-info btnsearch"><span class="glyphicon glyphicon-eye-open"></span> 查看消息</a>
                    			</div>
                    			<div class="col-md-4">
            ...
            <div class="col-md-7">
               ...
               <table class="table table-bordered table-hover">
                   ...
                   <tr><td>文件大小统计</td>
                    ...
                    <td><?php echo ($filenumandsize["thistermsize"]); ?></td>
                    <td><?php echo ($filenumandsize["totalsize"]); ?></td>
                   </tr>
                   <tr><td>讨论区交流条数</td>
