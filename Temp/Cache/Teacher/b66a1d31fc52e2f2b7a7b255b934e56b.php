...
<div class="panel panel-default">
	  ...
	  <div class="panel-body">
		 <table class="table table-bordered table-hover tablesorter" style="font-size: 11px;">
		  <thead>
			<tr style="text-align: center;font-weight: bold;"><td width="50px">ID</td><td width="100px">学期</td><td>课程</td><td width="70px">任务数</td><td>接收</td><td>提交</td><td width="60px">完成率</td><td width="100px">文件</td><td width="120px">班级</td><td width="140px">班主任<td width="190px">操作</td></tr>
			</thead>
			<tbody>
