...
<div class="panel panel-default">
  <!-- Default panel contents -->
	  ...
	  <div class="panel-body">   
		   ...
		   <thead>
		   <tr style="text-align: center;font-weight: bold;"><th style="text-align: center;" width="8%">序号</th><td align="left" width="12%">标题</td><td align="left">内容</td><th style="text-align: center;" width="10%">管理员</th><th style="text-align: center;" width="18%">发布时间</th></tr>
		   </thead>
		   <tbody>
		...
		<div id="pager" class="pager">
			<form>
			    <span class="label label-default" style="display:inline-block;height: 26px;line-height: 20px;">当前消息条数 <?php echo ($num); ?></span>
