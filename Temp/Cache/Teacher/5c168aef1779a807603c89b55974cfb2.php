...
<div class="panel panel-default">
	  <div class="panel-heading">发布任务(您正在为<strong><?php echo ($coursename); ?></strong>发布任务)</div>
	  ...
	  <div class="panel-footer">
	      ...
	      <button class="btn btn-info" type="submit" ><span class="glyphicon glyphicon-check"></span> 发布</button>
