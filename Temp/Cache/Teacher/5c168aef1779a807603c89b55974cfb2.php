...
<div class="panel panel-default">
	  ...
	  <div class="panel-body">
		<table class='table table-bordered table-hover'>	
			<tr>
				<td width="20%">课程名称:</td>
				<td align="left"><?php echo ($coursename); ?>(科任教师：<?php echo ($jsxm); ?>)</td>	
			</tr>
			<tr>
				<td>任务标题:</td>
				<td>
			...
			<tr>
				...
				<td style="text-align: left;height: 30px;">
					<div class="form-inline">
				    	<label class="xb">
				    		<input type="radio" name="isup" class="form-control" value="1" checked onclick="isupload(this)"> 是  
				    	</label>&nbsp;&nbsp;&nbsp;&nbsp;
				    	<label class="xb">
				    		<input type="radio" name="isup" class="form-control" value="2" onclick="isupload(this)"> 否	
				    	</label>
				    </div>
				</td>
			</tr>
				   ...
				   <div class="form-inline">
				     <input type="file"  name="file_upload"  class="form-control" />
				       <div style="text-align: left;">
						 <span class="glyphicon glyphicon-info-sign"></span> 附件<font size="4" color="red">最大支持100M</font>.多文件时,请先压缩再上传,建议上传文件为zip格式.
				         </div>
				    </div>
				</td>
			</tr>
