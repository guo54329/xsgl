...
<div class="panel panel-default">
	  <div class="panel-heading headalign">
			<a  class="btn  btncoursetable"><span class="glyphicon glyphicon-home"></span> 现有消息</a>
			<span style="float: right;"><a href="<?php echo U(GROUP_NAME.'/News/newsSave');?>" class="btn btn-info btnw" ><span class="glyphicon glyphicon-bullhorn"></span> 发布消息</a></span>
	  </div>
	  <div class="panel-body">
		<table class="table table-bordered table-hover tablesorter">
		   <thead>
			 <tr style="text-align: center;font-weight: bold;"><th style="text-align: center;" width="7%">序号</th><td width="12%">标题</td><td>内容</td><th style="text-align: center;" width="15%">接收班级</th><th style="text-align: center;" width="18%">发布时间</th><td width="10%">操作</td></tr>
		   </thead>
		   <tbody>
		   	<?php $i=1;?>
			<?php if(is_array($info)): foreach($info as $key=>$v): ?><tr align='center'>
				...
				<td align='center'><?php echo ($v["cname"]); ?></td>
