...
<body>
<form action='<?php echo U(GROUP_NAME.'/News/addNews');?>' method='post'>
<div class="panel panel-default">
	  ...
	  <div class="panel-footer"><input id="sub" type='submit'  value='发布' class="btn btn-info"/></div>
</div>
</form>
</body>
</html>